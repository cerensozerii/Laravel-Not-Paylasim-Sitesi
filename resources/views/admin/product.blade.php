                                            ...
                                            @foreach($datalist as $rs)
                                                <tr>
                                                    ...
                                                    <td><a href="{{route('admin_image_add',['product_id'=> $rs->id])}}" onclick="return window.open(this.href, '','top=50 left=100 width=1100,height=700')">
                                                            <img src="{{asset('assets/admin/images')}}/gallery-3.jpeg" height="25"> </a></td>
                                                    <td> <a href="{{route('admin_product_edit',['id'=> $rs->id])}}" onclick=""> <img src="{{asset('assets/admin/images')}}/edit.jpeg" height="25"> </a>
                                                    </td>
                                                    <td> <a href="{{route('admin_product_delete', ['id'=> $rs->id])}}" onclick="return confirm('Delete! Are you sure ?')"> <img src="{{asset('assets/admin/images')}}/delete.jpeg" height="25"> </a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </table>
