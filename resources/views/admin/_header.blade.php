                ...
                <a class="navbar-brand" href="{{route('admin_home')}}">
                    ...
                    <!-- Logo text --><span>
                         ...
                         <img src="{{asset('assets')}}/admin//assets/images/logo-text.png" alt="homepage"
                              class="dark-logo"/>
                        <!-- Light Logo text -->
                         <img src="{{asset('assets')}}/admin//assets/images/logo-light-text.png" class="light-logo"
                              alt="homepage"/></span> </a>
            </div>
            <!-- ============================================================== -->
            <!-- End Logo -->
                                    ...
                                    <div class="message-center">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img
                                                    src="{{asset('assets')}}/admin//assets/images/users/1.jpg"
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img
                                                    src="{{asset('assets')}}/admin//assets/images/users/2.jpg"
                                                    alt="user" class="img-circle"> <span
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img
                                                    src="{{asset('assets')}}/admin//assets/images/users/3.jpg"
                                                    alt="user" class="img-circle"> <span
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img
                                                    src="{{asset('assets')}}/admin//assets/images/users/4.jpg"
                                                    alt="user" class="img-circle"> <span
