                    ...
                    <div class="card">
                        <form class="form p-t-20" action="{{route('admin_product_store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="string" name="slug" value="5" class="form-control" placeholder="slug" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="string" name="files" value="0" class="form-control" placeholder="files" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="string" name="lectures" class="form-control" placeholder="lectures" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="string" name="subject" value="0" class="form-control" placeholder="subject" aria-label="Password" aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="integer" name="grade" value="5" class="form-control" placeholder="grade" aria-label="Password" aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="string" name="department" class="form-control" placeholder="department" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="string" name="teacher" class="form-control" placeholder="teacher" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="string" name="school" value="5" class="form-control" placeholder="school" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="detail"  class="form-control" placeholder="detail" aria-label="Password"
                                           aria-describedby="basic-addon3">
                                </div>
                            </div>
